...
class ColorRes {
  ...
  static const Color appColor = Color(0xFF1A237E);        // Deep Indigo Blue
  static const Color appBackColor = Color(0xFFF4F6FB);    // Cool white-blue tint
  static const Color appButtonColor = Color(0xFF283593);

  // static const Color appColor = Color(0xFF00695C);        // Deep Teal
  // static const Color appBackColor = Color(0xFFF0FAF9);    // Mint white
  // static const Color appButtonColor = Color(0xFF00796B);
  //
  // // 4️⃣ Deep Burgundy Red — bold & premium
  // static const Color appColor = Color(0xFF880E4F);
  // static const Color appBackColor = Color(0xFFFFF5F8);
  // static const Color appButtonColor = Color(0xFFAD1457);
